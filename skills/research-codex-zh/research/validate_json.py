...
CATEGORY_MAPPING = {
    ...
    "research_frame": ["research_frame", "Research Frame", "研究框架"],
    "information_collection": ["information_collection", "Information Collection", "信息收集"],
    "industry_structure": ["industry_structure", "Industry Structure", "行业结构"],
    "business_quality": ["business_quality", "Business Quality", "公司质量"],
    "moat_roic": ["moat_roic", "Moat and ROIC", "护城河与ROIC"],
    "financial_quality": ["financial_quality", "Financial and Cash Flow", "财务与现金流"],
    "growth_quality": ["growth_quality", "Growth Quality", "增长质量"],
    "market_expectation": ["market_expectation", "Market Expectation", "市场预期", "市场预期 / 叙事"],
    "expectation_gap": ["expectation_gap", "Expectation Gap", "预期差", "预期差分析"],
    "valuation": ["valuation", "Valuation and IRR", "估值与IRR"],
    "risk_falsification": ["risk_falsification", "Risk and Falsification", "风险与证伪", "风险与证伪点"],
    "investment_committee": ["investment_committee", "Investment Committee", "投资结论"],
    "company_profile": ["company_profile", "Company Profile", "公司画像"],
    "moat_analysis": ["moat_analysis", "Moat Analysis", "护城河分析"],
    "earning_power": ["earning_power", "Earning Power", "赚钱能力"],
    "cash_flow_quality": ["cash_flow_quality", "Cash Flow Quality", "现金流质量"],
    "core_variables": ["core_variables", "Core Variables", "未来 1-3 年核心变量", "未来1-3年核心变量", "关键变量"],
    "valuation_return": ["valuation_return", "Valuation and Return", "估值与回报率", "估值分析"],
    "scenario_analysis": ["scenario_analysis", "Scenario Analysis", "三种情景推演", "情景推演"],
    "final_decision": ["final_decision", "Final Decision", "最终结论", "当前判断"],
    "industry_analyst": ["industry_analyst", "Industry Analyst", "行业结构分析"],
    "moat_analyst": ["moat_analyst", "Moat Analyst", "公司质量分析"],
    "financial_analyst": ["financial_analyst", "Financial Analyst", "财务与现金流"],
    "growth_analyst": ["growth_analyst", "Growth Analyst", "增长拆解"],
    "market_expectation_analyst": ["market_expectation_analyst", "Market Expectation Analyst", "市场预期分析"],
    "valuation_analyst": ["valuation_analyst", "Valuation Analyst", "估值与回报率"],
    "risk_analyst": ["risk_analyst", "Risk Analyst", "证伪机制"],
    "investment_committee": ["investment_committee", "Investment Committee", "最终决策"],
}
